...
if INPUT_DATASET == '28ae':
    diffuser_opts = {
        ...
        'interior_attention': 1000, # don't do any attention
    }
else:
...
data = datasets.NewTwitchDataset(batch_size=BATCH_SZ, manual_shuffle=MANUAL_SHUFFLE, max_ts = 1)
